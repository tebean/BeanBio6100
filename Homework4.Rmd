...
```
condition1 <- numbers %% 2 != 0 #keeps numbers not divisible by 2
condition2 <- numbers %% 3 != 0 #keeps numbers not divisible by 3
condition3 <- numbers %% 7 != 0 #keeps numbers not divisible by 7
```
...
```
filtered_numbers <- numbers[condition1 & condition2 & condition3]
```
Print final filtered numbers
```
